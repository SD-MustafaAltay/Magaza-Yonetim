...
namespace Ticari_Otomasyon
{
    public partial class FrmAnaSayfa : Form
    {
        ...
        void stoklar()
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("Select Urunad,Sum(Adet) as 'Adet' From TBL_URUNLER group by Urunad having Sum(adet)<=1 order by Sum(adet)", bgl.baglanti());
            da.Fill(dt);
        ...
        private void GridControlStoklar_Click(object sender, EventArgs e)
        {
